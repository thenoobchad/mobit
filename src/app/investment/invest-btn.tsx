...
export const InvestBtn = ({ user, plan }: { user: User, plan: Packages }) => {
    ...
    return (<>
        ...
        {loading ? <p className='absolute top-1/2 right-1/2 animate-pulse'>Loading...</p> : error ? (<div className='absolute top-0 right-0 w-screen h-screen bg-black/10 flex flex-col justify-center items-center'>
